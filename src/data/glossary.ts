...
export const GLOSSARY: GlossaryEntry[] = [
  ...
  {
    term: '차콜',
    meaning: '숯색 — 블랙에 아주 가까운 진회색',
    sub: '블랙이나 진한 회색',
  },
  {
    term: '아이스블루',
    meaning: '얼음처럼 아주 연하고 차가운 하늘색',
    sub: '연한 하늘색 계열',
  },
  {
    term: '페일블루',
    meaning: '희끄무레하게 옅은 파랑 — 아이스블루보다 살짝 물빛',
    sub: '연한 하늘색 계열',
  },
  {
    term: '페일그레이',
    meaning: '흰색에 가까운 아주 옅은 회색',
    sub: '라이트 그레이',
  },
  {
    term: '오프화이트',
    meaning: '순백에서 살짝 벗어난 부드러운 흰색',
    sub: '아이보리나 흰색',
  },
  {
    term: '무광',
    meaning: '광택이 없는 매트한 표면 — 차분하고 고급스러워 보임',
    sub: '광택 적은 소재면 동일',
  },
  {
    term: '진청',
    meaning: '어둡고 진한 남색 데님',
    sub: '어두운 청바지',
  },
  {
    term: '에크루',
...
/**
 * 옷장에 "있다/없다"로 말할 수 없는 용어 (FR-33).
 *
 * 용어 사전에는 옷 이름뿐 아니라 색(차콜·캐멀), 마감(무광), 핏·디테일(테이퍼드·크루넥·
 * 더블브레스티드)도 함께 들어 있다. 이런 항목에까지 "이건 없어요" 버튼을 달면
 * "차콜을 가지고 있지 않다"는 말이 되어 뜻이 통하지 않는다 (QA).
 * 이 목록에 든 용어는 버튼을 감추되, 기본 화면의 "없으면: ○○" 안내는 그대로 보여 준다.
 */
const NOT_OWNABLE = new Set([
  // 색
  '차콜', '아이스블루', '페일블루', '페일그레이', '오프화이트', '진청', '에크루', '오트밀',
  '캐멀', '버건디', '세이지', '그레이지', '인디고',
  // 마감·가공
  '무광',
  // 핏·실루엣
  '테이퍼드', '와이드', '플리츠', '밴딩', '미드게이지',
  // 디자인 디테일(여밈·목선·코끝)
  '더블브레스티드', '오픈카라', '크루넥', '보트넥', '플레인토',
]);

/** 이 용어를 "가지고 있다/없다"로 표시할 수 있는가 */
export function isOwnableItem(term: string): boolean {
  return !NOT_OWNABLE.has(term);
}
